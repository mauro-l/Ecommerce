...
import footer from './bkg_footer.png'
        ...
        <>
            ...
            <footer className="bottom-0 w-full bg-bfooter dark:bg-gray-900">
                <div className="relative w-full max-w-screen-xl p-4 py-6 mx-auto bg-bfooter lg:py-8">
                    ...
                    <div className="my-6 md:mb-0">
                        <a href="#" className="flex items-center">
                            <img src={logo} className="h-8 me-3" alt="Otaku Logo" />
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="font-medium text-gray-300 dark:text-gray-400">
                                ...
                                <li>
                                    <a href="mailto" className="hover:underline">info@mail.com</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-300 sm:text-center dark:text-gray-400">© 2024 <a href="#" className="hover:underline">MauroLaime™</a>. All Rights Reserved.
                    </span>
