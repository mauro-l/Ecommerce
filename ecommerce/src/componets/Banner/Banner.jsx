...
function Banner({greeting, categoryId, subcategory}) {
  ...
  return (
    <div className='relative'>
      ...
      <h2 className={`${categoryId? 'absolute' : 'hidden' } flex items-center justify-center text-lg text-white transform -translate-x-1/2 -translate-y-1/2 font-roboto mt-11 md:mt-14 top-1/2 left-1/2 md:text-xl`}>
        {category}
